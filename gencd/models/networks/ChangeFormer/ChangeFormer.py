...
- img_size as parameter for ChangeFormer (img_size=256 was fixed in original)
...
class ChangeFormerV6(nn.Module):
    ...
    def __init__(self, img_size=256, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=256):
