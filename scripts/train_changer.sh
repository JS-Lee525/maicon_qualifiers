...
net_config=config/opencd/changer/changer_s101_512x512_40k_levircd.py
load_pretrained_network=temp/pretrained/ChangerEx_s101-512x512_80k_s2looking_weight.pt
